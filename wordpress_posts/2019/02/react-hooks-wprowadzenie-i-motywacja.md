...
[gallery columns="2" link="file" size="medium" ids="1835,1838"]

Minifikacja:

[gallery columns="2" link="file" size="medium" ids="1837,1836"]
...
Świetnie! Szczęśliwie się składa, że **właśnie pracuję nad kolejną częścią kursu React Hooks** ;) Jeśli jednak bardzo Ci się spieszy to zajrzyj tutaj: [typeofweb-courses-slogan category="React"]
