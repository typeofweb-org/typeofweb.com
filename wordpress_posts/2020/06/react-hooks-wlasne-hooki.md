...
<p class="codepen" data-height="485" data-theme-id="light" data-default-tab="js,result" data-user="mmiszy" data-slug-hash="LYpaaPN" style="height: 485px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="React Hooks: Własny hook useApi">
  <span>See the Pen <a href="https://codepen.io/mmiszy/pen/LYpaaPN/">
  React Hooks: Własny hook useApi</a> by Michał Miszczyszyn (<a href="https://codepen.io/mmiszy">@mmiszy</a>)
