...
<pre><code class="language-typescript">const Injectable = Target =&gt; {}</code></pre>
...
<pre><code class="language-typescript">type ClassDecorator&lt;T extends Function&gt; = (Target: Constructor&lt;T&gt;) =&gt; T | void;</code></pre>
...
<pre><code class="language-typescript">Reflect.getMetadata('design:paramtypes', Target)</code></pre>
