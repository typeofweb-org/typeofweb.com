...
export const SingleArticle = forwardRef<HTMLElement, SingleArticleProps>(
  ({ coverUrl, id, title, authors, mainCategory, href }, ref) => {
    return (
      <Card as="article" roundAllCorners={true} moreSpace={true} ref={ref}>
        <header className="bg-gray-200">
          <div className={`px-7 sm:px-8 lg:px-12 bg-gray-100 pb-6 ${coverUrl ? 'pt-0' : 'mb-6'}`}>
          ...
          {coverUrl && <ArticleCoverImage coverUrl={coverUrl} wide={true} />}
        </header>
        <div className="prose lg:prose-xl pb-2 px-7 sm:px-8 lg:px-12">
          ...
          <p>
            ...
            krótkiego fragmentu do&nbsp;istniejącego projektu często wymaga przeczytania kilku lub kilkunastu linii
            kodu. To&nbsp;jeden z&nbsp;powodów, dla których&nbsp;czytelność powinna stać na&nbsp;pierwszym miejscu.{' '}
          ...
          <p>
            ...
            się&nbsp;zapalić ostrzegawcza lampka. Jakie jest przyspieszenie? Ile milisekund? Ile procent? Jaki
            to&nbsp;ma wpływ na&nbsp;postrzeganą&nbsp;prędkość aplikacji i&nbsp;na&nbsp;UX?{' '}
            <strong>
          ...
          <blockquote>
            <p>
              Jestem pewien, że&nbsp;to&nbsp;działa szybciej. Operacje na&nbsp;gołym DOM muszą być szybsze niż
              framework, to&nbsp;chyba oczywiste?
            </p>
          </blockquote>
          <p>
            ...
            prawdziwa – istnieją biblioteki, które dzięki mądrym rozwiązaniom, potrafią renderować&nbsp;HTML szybciej
            niż gdybyśmy ręcznie operowali na&nbsp;gołym DOM.
          </p>
          <blockquote>
            <p>
          ...
          <blockquote>
            <p>
              Gdy&nbsp;piszę swój kod, to&nbsp;od&nbsp;razu dostrzegam miejsca, które w&nbsp;oczywisty sposób mogą
              zostać zoptymalizowane. Nauczyli mnie tego na&nbsp;studiach: gdy&nbsp;programowałem mikroprocesory
              z&nbsp;8KB RAM w&nbsp;języku C to&nbsp;często robiłem wstawki asemblerowe, żeby&nbsp;było szybciej.
              Czytelność jest ważna, ale&nbsp;na&nbsp;pewno nie&nbsp;najważniejsza.
              <br />
          ...
          <p>
            ...
            W&nbsp;innym wypadku – nie&nbsp;(chyba, że&nbsp;Tomasz ma magiczną kryształową kulę). Niestety takie
            podejście bardzo często pokutuje wśród osób przyzwyczajonych do&nbsp;programowania w&nbsp;językach
            niskopoziomowych. Najczęstsze grzechy to&nbsp;obawa przed&nbsp;tworzeniem wielu małych funkcji i&nbsp;ręczne{' '}
          ...
          <p>
            ...
            procesora nie&nbsp;szkodzi. Cóż, wiedza chyba nigdy nie&nbsp;przeszkadza! Ale&nbsp;próba stosowania
            zwyczajów i&nbsp;porad wyniesionych z&nbsp;dawnych lat, albo&nbsp;z&nbsp;języków niskopoziomowych
            w&nbsp;językach nowoczesnych nie&nbsp;tylko&nbsp;nikomu nie&nbsp;pomaga, ale&nbsp;wręcz szkodzi.
          </p>
          <p>
          ...
          <p>
            ...
            <strong>Niemożliwe jest napisanie całkowicie optymalnego kodu od&nbsp;zera</strong> z&nbsp;przynajmniej
            dwóch powodów. Po&nbsp;pierwsze, jak już wspomniałem, nie&nbsp;wiesz jak dokładnie zadziała kompilator
          ...
          <p>
            ...
            rysowanie SVG nie&nbsp;były żadnym problemem. Problemem była zła architektura aplikacji i&nbsp;przepływ
            danych oraz&nbsp;zdarzeń, przez&nbsp;które wykres często był przerysowywany kilkukrotnie bez&nbsp;żadnych
            zmian. Kto by&nbsp;pomyślał! Poprawki zajęły sporo czasu, ale&nbsp;efekty były bardzo dobre: poprawa czasów
            renderowania o&nbsp;75%.
          </p>
          ...
          <p>
            ...
            <code>x</code> zamiast <code>playerPosition</code> zyskujemy ok. 1&nbsp;sekundy. Jeśli pomnożymy
            to&nbsp;razy 10000&nbsp;linii kodu to&nbsp;otrzymujemy prawie 3&nbsp;godziny. Co za&nbsp;wynik, będziemy
            pierwsi na&nbsp;rynku, hurra!
          </p>
          <p>
          ...
          <p>
            ...
            na&nbsp;uprawie rolnej, ale&nbsp;jestem pewien, że&nbsp;orka jest łatwiejsza, jeśli na&nbsp;polu
            nie&nbsp;leżą miny. Nieczytelny kod to&nbsp;właśnie taka mina. Taka tam alegoria.
          </p>
          <h2 id="dlarwnowagi">Dobry kod dla równowagi…</h2>
          <p>
            Nie&nbsp;panikujmy jeszcze, nie&nbsp;jest aż tak&nbsp;źle! To&nbsp;nie&nbsp;jest przecież tak,
            że&nbsp;wszyscy programiści w&nbsp;Polsce mają w&nbsp;poważaniu jakość pisanego kodu, a&nbsp;czytelny kod
            to&nbsp;dla nich czarna magia. Nie&nbsp;każdy od&nbsp;razu używa{' '}
            <LinkUnderlineEffect>
          ...
          <div className="footnotes">
            <ol>
              ...
              <li className="footnote" id="fn-2">
                <p>
                  W&nbsp;99,9% przypadków. Optymalizować warto, gdy&nbsp;udało się zlokalizować przyczynę,
                  ale&nbsp;nigdy na&nbsp;oślep.{' '}
