...
export const MainNav = memo(() => {
  ...
  return (
    ...
    >
      <div className="overflow-scrolling-touch pb-24 pt-16 w-full max-h-screen overflow-y-scroll overscroll-y-none">
        <ul className="flex flex-1 flex-col gap-8 items-center justify-center text-3xl lg:flex-row lg:gap-0 lg:items-stretch lg:justify-around lg:text-base">
          {navItems.map((item) => {
