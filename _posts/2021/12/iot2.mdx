...
category: opinie
thumbnail:
  url: https://res.cloudinary.com/type-of-web/image/upload/v1639002639/iot-smart-home-architektura-z-wave-i-zastosowania_hwnco8.png
  width: 1920
  height: 1004
---
...
<Gallery columns="2">
  <img
    ...
    height="440"
  />
  Centrala inteligentnego domu Fibaro Home Center 3
  {'\n'}Zdjęcie pochodzi ze strony fibaro.com
  ...
  <img
    ...
    height="440"
  />
  Centrala inteligentnego domu Ezlo Secure (dawniej Vera)
  {'\n'}Zdjęcie pochodzi ze strony getvera.com
</Gallery>
...
<Gallery columns="1">
  <img
    src="https://res.cloudinary.com/type-of-web/image/upload/v1639000805/web_slika-1-1170x658_b2pbza.jpg"
    alt="Schemat siatki (mesh) w z-wave"
    width="585"
    height="329"
  />
  Schemat siatki (mesh) w z-wave
  {'\n'}Zdjęcie pochodzi ze strony qubino.com
</Gallery>
...
<Gallery columns="1">
  <img
    src="https://res.cloudinary.com/type-of-web/image/upload/v1639000885/main_r1huaw.jpg"
    alt="Typowy łącznik roletowy"
    width="300"
    height="300"
  />
  Typowy łącznik roletowy
  {'\n'}Zdjęcie pochodzi ze strony leroymerlin.pl
</Gallery>
...
<Gallery columns="1">
  <img
    src="https://res.cloudinary.com/type-of-web/image/upload/v1639001315/Screenshot_2021-12-08_at_23.07.26_rzt8iu.png"
    alt="Zamontowany roller shutter bez problemu mieści się w puszcze w ścianie"
    width="403"
    height="271"
  />
  Zamontowany roller shutter bez problemu mieści się w puszcze w ścianie
  {'\n'}Zdjęcie pochodzi z instrukcji Fibaro
</Gallery>
...
<Gallery columns="1">
  <img
    src="https://res.cloudinary.com/type-of-web/image/upload/v1639001399/Screenshot_2021-12-05_at_20.47.36_qbjrs9.png"
    alt="Blokowy edytor scen pozwala na tworzenie scenariuszy nawet osobom niepotrafiącym programować"
    width="1004"
    height="563"
  />
  Blokowy edytor scen pozwala na tworzenie scenariuszy nawet osobom niepotrafiącym programować
  {'\n'}Zdjęcie pochodzi z filmu youtu.be/akHjalzUCR0
</Gallery>
